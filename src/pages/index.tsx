...
const Home = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('l@lawerencemillard.lol')
    theme === 'dark'
  ...
  return (
    <>
      <GenericMeta
        title="Lawrence Millard"
        description="14-year-old software engineer and student from the United Kingdom."
      />

      <MainLayout margin={false}>
        <h1 className="text-6xl font-bold">Lawrence</h1>
